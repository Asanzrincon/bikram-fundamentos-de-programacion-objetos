describe("Objetos", () => {
    describe("Declaración", () => {
        ...
        describe("3.- Crea un 'objeto' de nombre 'Noticia' que tenga las propiedades: 'titular, cuerpo'", () => {
        ...
        describe("4.- Crea un 'objeto' de nombre 'Persona' que tenga las propiedades: 'nombre, apellidos, edad'", () => {
        ...
        describe("5.- Crea un 'objeto' de nombre 'Avion' que tenga las propiedades: 'numPasajeros, función despegar (imprime por consola 'despegando'), función volar (imprime por consola llegando al destino), función aterrizar (imprime por consola 'aterrizando')", () => {
        ...
        describe("6.- Crea un 'objeto' de nombre 'Paquete' que tenga la propiedad: 'array contenido con todos los objetos que contenga el paquete'", () => {
            it("Contiene la propiedad paquete de tipo array", () => {
                expect(Paquete.contenido).toEqual(jasmine.any(Array));
            });
        });
        describe("7.- Crea un 'objeto' de nombre 'Pais' que tenga las propiedades: 'numHabitantes, continente, gentilicio'", () => {
        ...
        describe("8.- Crea un 'objeto' de nombre 'FullStackDeveloper' que tenga las propiedades: 'array lenguajes, array proyectos'", () => {
        ...
        describe("9.- Crea un 'objeto' de nombre 'Perro' que tenga las propiedades: 'nombre, raza, color, edad, función ladrar (imprime por consola un ladrido), función popo (devuelve el valor: Math.random() * 3)'", () => {
            it("Contiene la propiedad nombre", () => {
    ...
    describe("Lectura de propiedades", () => {
        it("10.- Dado un 'objeto' de nombre 'Portatil' obtén el valor de la propiedad 'marca con .marca' guardándolo en la variable 'marcaPortatil'", () => {
            expect(marcaPortatil).toBe(Portatil.marca);
        });
        it("11.- Dado un 'objeto' de nombre 'Portatil' obtén el valor de la propiedad 'marca con ['marca'] guardándolo en la variable 'marcaPortatil2'", () => {
            expect(marcaPortatil2).toBe(Portatil["marca"]);
        });
        it("12.- Dado un 'objeto' de nombre 'O_Error' obtén el valor de la propiedad 'codigo' guardándolo en la variable 'codError'", () => {
            expect(codError).toBe(O_Error.codigo);
        });
        it("13.- Dado un 'objeto' de nombre 'Concierto' obtén el valor de la propiedad 'grupos' guardándolo en la variable 'grupos'", () => {
            expect(grupos).toEqual(Concierto.grupos);
        });
        it("14.- Dado un 'objeto' de nombre 'Grupo' obtén el valor de la propiedad 'integrantes' guardándolo en la variable 'integrantes'", () => {
            expect(integrantes).toEqual(Grupo.integrantes);
        });
        it("15.- Dado un 'objeto' de nombre 'Impresora' obtén el valor de la propiedad 'tinta' guardándolo en la variable 'nivelesTinta'", () => {
            expect(nivelesTinta).toEqual(Impresora.tinta);
        });
        it("16.- Dado un 'objeto' de nombre 'Pantalla' obtén el valor de la propiedad 'pixeles' guardándolo en la variable 'pixeles'", () => {
            expect(pixeles).toEqual(Pantalla.pixeles);
        });
        it("17.- Dado un 'objeto' de nombre 'Movil' obtén el valor de la propiedad 'especificaciones con ['especificaciones']' guardándolo en la variable 'especificaciones'", () => {
            expect(especificaciones).toEqual(Movil.especificaciones);
        });
        it("18.- Dado un 'objeto' de nombre 'Led' obtén el valor de las propiedades 'rojo, verde y azul' guardándolo en la variable 'array RGB[rojo, verde, azul]'", () => {
    ...
    describe("Modificación de propiedades", () => {
        it("19.- Dado un 'objeto' de nombre 'Portatil' modifica el valor de la propiedad 'modelo' por el valor 'P345'", () => {
            expect(Portatil.modelo).toBe("P345");
        })
        it("20.- Dado un 'objeto' de nombre 'Concierto' añade el valor 'Guns N' Roses' a la propiedad 'cartelera'", () => {
            expect(Concierto.cartelera).toEqual(["Queen", "Guns N' roses"]);
        })
        it("21.- Dado un 'objeto' de nombre 'Grupo' modifica el valor de la propiedad 'numIntegrantes' por el valor '5'", () => {
            expect(Grupo.numIntegrantes).toBe(5);
        })
        it("22.- Dado un 'objeto' de nombre 'Pantalla' modifica el valor de la propiedad 'dimensiones' por el valor '1920x1080'", () => {
            expect(Pantalla.dimensiones).toBe("1920x1080");
        })
        it("23.- Dado un 'objeto' de nombre 'Concierto' modifica el valor de la propiedad 'fecha' por el valor 'new Date'", () => {
            expect(Concierto.fecha).toEqual(jasmine.any(Date));
        })
        it("24.- Dado un 'objeto' de nombre 'Led' modifica el valor de la propiedad 'encendido' por el valor 'false si vale true y true si vale false'", () => {
            expect(Led.encendido).toBe(true);
        })
        it("25.- Dado un 'objeto' de nombre 'Impresora' modifica el valor de la propiedad 'imprimiendo' por el valor 'objeto con propiedades: nombreArchivo, copias, numPaginas'", () => {
